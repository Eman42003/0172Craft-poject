...
<head>
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css">
    ...
    <title>Craft | Upload New Product</title>
    <script>
    ...
    <center>
        <div class="main">
            <form action="insert.php" method="post" enctype="multipart/form-data">
                ...
                <br>
                <input type="text" name="name" class="uploadInput" placeholder="Product Name" required>
                <br>
                <input type="text" name="price" class="uploadInput" placeholder="Product Price" required>
                <br>
                ...
                <label for="file" class="uploadLabel">Upload Photo Product</label>
                <br>
                <button name="upload" id="btnDone">Upload</button>
                <br><br>
